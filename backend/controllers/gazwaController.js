...
const getAllGazwa = async (req, res) => {
    try {
        const gazwat = await gazwaModel.find({}, { story: 0, cause: 0, effect: 0, source: 0, country: 0, area_to_open: 0, leader_of_muslims: 0, location: 0, number_of_muslims: 0, enemy: 0, number_of_enemy: 0, leader_of_enemy: 0, audioUrl: 0, timings: 0 });

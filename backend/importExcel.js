...
const run = async () => {
  try {
    ...
    const mappedData = rawData.map(row => ({
      name: row["الاسم"],
      type: row["نوع الحدث"],
      area_to_open: row["فتح"] !== undefined ? row["فتح"] : "غير محدد",
      year: row["التاريخ"] !== undefined ? row["التاريخ"] : "لا يوجد سنة",
      leader_of_muslims: row["القائد"] !== undefined ? row["القائد"] : "غير محدد",
      era: row["عهد"],
      location: row["الموقع"],
      number_of_muslims: row["عدد المسلمين"] !== undefined ? row["عدد المسلمين"] : "غير محدد",
      enemy: row["الأعداء"] !== undefined ? row["الأعداء"] : "غير محدد",
      number_of_enemy: row["عدد الأعداء"] !== undefined ? row["عدد الأعداء"] : "غير محدد",
      leader_of_enemy: row["قائد الأعداء"] !== undefined ? row["قائد الأعداء"] : "غير محدد",
      story: row["القصة"],
